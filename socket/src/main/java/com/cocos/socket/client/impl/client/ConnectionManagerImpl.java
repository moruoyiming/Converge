package com.cocos.socket.client.impl.client;

import com.cocos.socket.core.iocore.interfaces.ISendable;
import com.cocos.socket.core.utils.SLog;
import com.cocos.socket.client.impl.client.action.ActionHandler;
import com.cocos.socket.client.impl.client.iothreads.IOThreadManager;
import com.cocos.socket.client.impl.exceptions.ManuallyDisconnectException;
import com.cocos.socket.client.impl.exceptions.UnConnectException;
import com.cocos.socket.client.sdk.client.ConnectionInfo;
import com.cocos.socket.client.sdk.client.OkSocketOptions;
import com.cocos.socket.client.sdk.client.OkSocketSSLConfig;
...
import com.cocos.socket.common.interfaces.default_protocol.DefaultX509ProtocolTrustManager;
import com.cocos.socket.common.interfaces.utils.TextUtils;
