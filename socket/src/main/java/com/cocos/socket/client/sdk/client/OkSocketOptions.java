package com.cocos.socket.client.sdk.client;
...
import com.cocos.socket.client.sdk.client.connection.AbsReconnectionManager;
import com.cocos.socket.client.sdk.client.connection.DefaultReconnectManager;
import com.cocos.socket.client.sdk.client.connection.abilities.IConfiguration;
import com.cocos.socket.common.interfaces.default_protocol.DefaultNormalReaderProtocol;
...
public class OkSocketOptions implements IIOCoreOptions {
     ...
     * 抛出{@link com.cocos.socket.client.impl.exceptions.DogDeadException}
     */
    ...
    public static class Builder {
         ...
         * 脉搏丢失次数<br>
         * 大于或等于丢失次数时将断开该通道的连接<br>
         * 抛出{@link com.cocos.socket.client.impl.exceptions.DogDeadException}<br>
         * 默认是5次
         *
         ...
         * 如果不需要断线重连请设置该参数为{@link com.cocos.socket.client.sdk.client.connection.NoneReconnect}
         *
