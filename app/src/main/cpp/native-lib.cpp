...
Java_com_example_hotfix_note_binder_MMAPActivity_writeTest(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_hotfix_note_binder_MMAPActivity_readTest(JNIEnv *env, jobject thiz) {
    //申请内存
