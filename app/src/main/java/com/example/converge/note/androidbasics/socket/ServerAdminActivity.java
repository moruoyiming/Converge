...
import com.example.converge.note.androidbasics.socket.data.AdminHandShakeBean;
import com.example.converge.note.androidbasics.socket.data.AdminKickOfflineBean;
import com.example.converge.note.androidbasics.socket.data.LogBean;
import com.example.converge.note.androidbasics.socket.data.RestartBean;
