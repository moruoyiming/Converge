package com.example.converge.note.jetpack.lifecycle;
...
import com.example.converge.note.jetpack.lifecycle.adapter.GoodsAdapter;
import com.example.converge.note.jetpack.lifecycle.bean.Goods;
import com.example.converge.note.jetpack.lifecycle.databus.LiveDataBus;
import com.example.converge.note.jetpack.lifecycle.presenter.GoodsPresenter;
import com.example.converge.note.jetpack.lifecycle.view.BaseActivity;
