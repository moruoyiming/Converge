package com.example.hotfix.activity.socket;
...
import com.example.hotfix.activity.socket.adapter.LogAdapter;
import com.example.hotfix.activity.socket.data.AdminHandShakeBean;
import com.example.hotfix.activity.socket.data.AdminKickOfflineBean;
import com.example.hotfix.activity.socket.data.LogBean;
import com.example.hotfix.activity.socket.data.RestartBean;
