...
import com.example.hotfix.activity.socket.data.DefaultSendBean;
import com.example.hotfix.activity.socket.data.HandShakeBean;
import com.example.hotfix.activity.socket.data.LogBean;
import com.example.hotfix.activity.socket.data.PulseBean;
