...
public class FishDrawable extends Drawable {
    ...
    // ----------鱼的各部位长度----------------
    // 鱼头半径
    private static final float HEAD_RADIUS = 60;
    // 身体的长度
    ...
    private PointF makeSegment(Canvas canvas, PointF bottomCenterPoint, float
        ...
        // 梯形的四个点
        PointF bottomLeftPoint = calculatPoint(bottomCenterPoint, bigCircleRadius, segmentAngle + 90);
        PointF bottomRightPoint = calculatPoint(bottomCenterPoint, bigCircleRadius, segmentAngle - 90);
        PointF upperLeftPoint = calculatPoint(upperCenterPoint, smallCircleRadius, segmentAngle + 90);
    ...
    private void makeTriangle(Canvas canvas, PointF startPoint, float
        ...
        // 三角形底边的两点
        PointF leftPoint = calculatPoint(centerPoint, triangleHalfLength, segmentAngle + 90);
    ...
    private void makeBody(Canvas canvas, PointF bodyBottomCenterPoint, float fishAngle) {
        ...
        PointF topRightPoint = calculatPoint(headPoint, HEAD_RADIUS, fishAngle - 80);
