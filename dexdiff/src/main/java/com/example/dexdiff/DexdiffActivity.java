...
public class DexdiffActivity extends Activity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dexdiff);
        testDiff();
    }
    ...
    public void patch(View view) {
        ...
        int result = BsPathUtils.patch(getApplicationInfo().sourceDir, newFile.getAbsolutePath(),
